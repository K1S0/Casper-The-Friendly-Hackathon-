...
We are going to use the cspr.live user interface to delegate and undelegate 10 CSPR to a Casper Testnet validator. The account 011178.....41d0c will be our delegator/undelegator and the chosen validator will be this one 017d9.....2009e .
